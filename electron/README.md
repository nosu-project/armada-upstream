...
the desktop ArmadaDB bridge. This prevents a current shell from being paired
with a stale renderer or silently falling back to a different storage engine.
