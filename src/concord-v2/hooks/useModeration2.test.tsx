...
import { VSK_BANLIST, VSK_GRANT } from "@/concord-v2/lib/kinds";
import { adminRole, type CommunityRoles } from "@/concord-v2/lib/roles";

import { useModeration2 } from "./useModeration2";
...
vi.mock("@/concord-v2/hooks/useRekey2", () => ({
  useRefound2: () => ({
...
vi.mock("@/concord-v2/lib/readCutPending", () => ({
...
function mount(recipients: string[]) {
  ...
  return renderHook(() => useModeration2(community, recipients), { wrapper });
}
