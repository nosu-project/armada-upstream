 ...
 * can act, and only off a complete sweep (see useSuspiciousActivity2).
 *
 ...
 */
export function SuspiciousActivityBanner2({
  community,
  folded,
  ban,
}: {
  ...
  const { actors, unreadable, flooded, alert, dismiss } = useSuspiciousActivity2(community, folded);
