...
import { KickMembersDialog } from "@/concord-v2/components/KickMembersDialog2";
...
import { useSuspiciousActivity2 } from "@/concord-v2/hooks/useSuspiciousActivity2";
import { describeAttempts, type SuspiciousActor } from "@/concord-v2/lib/auditLog";
import { KIND_COMMENT, KIND_MESSAGE } from "@/concord-v2/lib/kinds";
import { banShouldRotateMany } from "@/concord-v2/lib/control";
import {
  buildMemberRows,
  filterMemberRows,
  hoistSuspicious,
...
import { clickRow, emptySelection, pruneSelection, type SelectionState } from "@/concord-v2/lib/rosterSelection";
...
export function MembersView({
  ...
  const { actors: suspiciousActors } = useSuspiciousActivity2(community, folded);
  ...
  const { members, coalesced } = useMembers2(community, observed.seenMs);
