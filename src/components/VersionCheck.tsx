...
/**
 * Compares the running app version against localStorage and shows a "What's
 * new" toast when the version changes. Rendered once at the app root (inside
 * <BrowserRouter> so the toast's "See all" link resolves).
 */
