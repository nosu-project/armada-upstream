import { Check, Loader2, Plus, SmilePlus } from "lucide-react";
...
/**
 * Attribution footer for a custom-emoji reaction: which NIP-30 pack it came
 * from, plus a one-tap add so seeing an emoji you like is enough to get it.
 *
 ...
 */
function EmojiSourceFooter({ url }: { url: string }) {
