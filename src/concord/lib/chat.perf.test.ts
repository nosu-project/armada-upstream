...
import { KIND_EDIT, KIND_MESSAGE, KIND_REACTION } from "@/concord/lib/kinds";
 ...
 * channel switch (useChannel.ts:400-407 re-derives it from `query.data`). So
 ...
 *
 * A warm channel loads WINDOW_SIZE = 100 (useChannel.ts:58); scrolling history
