 ...
 * `### Added` / `### Changed` / etc. heading. The summary is used as the Play
 * Store release blurb ("What's new in this version"). The full section body is
 * used as the release description on the GitLab mirror.
 *
 * Format:
 *
 *   ## [X.Y.Z] - YYYY-MM-DD
 ...
 *              Falls back to "Armada vX.Y.Z" if the section has no summary.
...
if (summary) {
  ...
  stdout.write(text ?? `Armada v${version}`);
  stdout.write('\n');
} else {
